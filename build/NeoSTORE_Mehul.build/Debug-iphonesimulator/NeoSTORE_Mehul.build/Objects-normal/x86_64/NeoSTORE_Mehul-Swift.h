...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NeoSTORE_Mehul",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14NeoSTORE_Mehul11AppDelegate")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC14NeoSTORE_Mehul25CustomDatePickerTextField")
@interface CustomDatePickerTextField : UITextField
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC14NeoSTORE_Mehul17CustomUITextField")
...
SWIFT_CLASS("_TtC14NeoSTORE_Mehul19LoginViewController")
...
SWIFT_CLASS("_TtC14NeoSTORE_Mehul13SceneDelegate")
...
@interface UIButton (SWIFT_EXTENSION(NeoSTORE_Mehul))
@property (nonatomic) IBInspectable CGFloat borderWidth;
@property (nonatomic) IBInspectable CGFloat cornerRadius;
...
SWIFT_CLASS("_TtC14NeoSTORE_Mehul14ViewController")
